 ...
 */
@Implementation(source = ProcessActionA2D.class)
public class ProcessActionA2D extends Processor<Object> {

    private final static Logger LOGGER = LoggerFactory.getLogger(ProcessActionA2D.class);
